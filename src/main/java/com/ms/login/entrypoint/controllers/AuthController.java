...
public class AuthController implements AutenticaoApi {
    ...
    //TODO TOMORROW:
    // [] Criar a classe de config para reconher o bean.
    // [] Criar um usuario qualquer no banco ,
    // [] Fazer o primeiro teste se esta gerando o token
    // [] Com toda essa parte de cima feita e funcionando, proximo passo e o refresh token
